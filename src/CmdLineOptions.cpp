...
namespace xmreg
{
    ...
    CmdLineOptions::CmdLineOptions(int acc, const char *avv[]) {
        ...
        options_description desc(
                "xmrblocks, MonetaVerde Blockchain Explorer");
        ...
        desc.add_options()
                ...
                ("enable-emission-monitor", value<bool>()->default_value(false)->implicit_value(true),
                 "enable MonetaVerde total emission monitoring thread")
                ...
                ("bc-path,b", value<string>(),
                 "path to lmdb folder of the blockchain, e.g., ~/.monetaverde/lmdb")
                ...
                ("deamon-url,d", value<string>()->default_value("http:://127.0.0.1:36081"),
                 "MonetaVerde deamon url");
