...
main(int ac, const char* av[])
{
    ...
    if (testnet && deamon_url == "http:://127.0.0.1:46080")
        deamon_url = "http:://127.0.0.1:46081";
    if (stagenet && deamon_url == "http:://127.0.0.1:56080")
        deamon_url = "http:://127.0.0.1:56081";
    ...
    CROW_ROUTE(app, "/")
    ([&]() {
        return myxmr::htmlresponse(mcnblocks.index2());
    });

    CROW_ROUTE(app, "/page/<uint>")
    ([&](size_t page_no) {
        return myxmr::htmlresponse(mcnblocks.index2(page_no));
    });

    CROW_ROUTE(app, "/block/<uint>")
    ([&](size_t block_height) {
        return myxmr::htmlresponse(mcnblocks.show_block(block_height));
    });

    CROW_ROUTE(app, "/block/<string>")
    ([&](string block_hash) {
        return myxmr::htmlresponse(
                mcnblocks.show_block(remove_bad_chars(block_hash)));
    });

    CROW_ROUTE(app, "/tx/<string>")
    ([&](string tx_hash) {
        return myxmr::htmlresponse(
                mcnblocks.show_tx(remove_bad_chars(tx_hash)));
    });
    if (enable_autorefresh_option)
    {
        ...
        ([&](string tx_hash) {
            ...
            return myxmr::htmlresponse(
                mcnblocks.show_tx(remove_bad_chars(tx_hash), with_ring_signatures, refresh_page));
        });
    }
    ...
    if (enable_as_hex)
    {
        ...
        ([&](string tx_hash) {
            return crow::response(
                    mcnblocks.show_tx_hex(remove_bad_chars(tx_hash)));
        });

        CROW_ROUTE(app, "/ringmembershex/<string>")
        ([&](string tx_hash) {
            return crow::response(
                    mcnblocks.show_ringmembers_hex(remove_bad_chars(tx_hash)));
        });

        CROW_ROUTE(app, "/blockhex/<uint>")
        ([&](size_t block_height) {
            return crow::response(
                    mcnblocks.show_block_hex(block_height, false));
        });

        CROW_ROUTE(app, "/blockhexcomplete/<uint>")
        ([&](size_t block_height) {
            return crow::response(
                    mcnblocks.show_block_hex(block_height, true));
        });
...
//        });
        ...
        ([&](string tx_hash) {
            return myxmr::jsonresponse {
                mcnblocks.show_ringmemberstx_jsonhex(
    ...
    if (enable_autorefresh_option)
    {
        ...
        ([&](string tx_hash, uint16_t with_ring_signature) {
            bool refresh_page {true};
            return myxmr::htmlresponse(
                mcnblocks.show_tx(remove_bad_chars(tx_hash), with_ring_signature, refresh_page));
        });
    }
    ...
    ([&](const crow::request& req) -> myxmr::htmlresponse
     {
        ...
        if (post_body.count("mcn_address") == 0
            || post_body.count("viewkey") == 0
            || post_body.count("tx_hash") == 0)
        {
            return string("mcn address, viewkey or tx hash not provided");
        }

        string tx_hash     = remove_bad_chars(post_body["tx_hash"]);
        string mcn_address = remove_bad_chars(post_body["mcn_address"]);
        ...
        string response = mcnblocks.show_my_outputs(
                                         tx_hash, mcn_address,
                                         viewkey, raw_tx_data,
                                         domain);
    ...
    ([&](const crow::request& req, string tx_hash,
        string mcn_address, string viewkey)
     {

        string domain = get_domain(req);

        return myxmr::htmlresponse(mcnblocks.show_my_outputs(
                                         remove_bad_chars(tx_hash),
                                         remove_bad_chars(mcn_address),
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse 
         {
            ...
            if (post_body.count("mcnaddress") == 0
                || post_body.count("txprvkey") == 0
                || post_body.count("txhash") == 0)
            {
                return string("mcn address, tx private key or "
            ...
            string mcn_address = remove_bad_chars(post_body["mcnaddress"]);
            ...
            return myxmr::htmlresponse(mcnblocks.show_prove(tx_hash,
                                        mcn_address,
                                        tx_prv_key,
                                        raw_tx_data,
                                        domain));
    ...
    ([&](const crow::request& req, string tx_hash,
         string mcn_address, string tx_prv_key) 
     {

        string domain = get_domain(req);

        return myxmr::htmlresponse(mcnblocks.show_prove(
                                    remove_bad_chars(tx_hash),
                                    remove_bad_chars(mcn_address),
    ...
    if (enable_pusher)
    {
        ...
        ([&]() {
            return myxmr::htmlresponse(mcnblocks.show_rawtx());
        });
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse
         {
            ...
            if (action == "check")
                return myxmr::htmlresponse(
                        mcnblocks.show_checkrawtx(raw_tx_data, action));
            else if (action == "push")
                return myxmr::htmlresponse(
                        mcnblocks.show_pushrawtx(raw_tx_data, action));
    ...
    if (enable_key_image_checker)
    {
        ...
        ([&]() {
            return myxmr::htmlresponse(mcnblocks.show_rawkeyimgs());
        });
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse
         {
            ...
            return myxmr::htmlresponse(
                    mcnblocks.show_checkrawkeyimgs(raw_data, viewkey));
        });
    }
    ...
    if (enable_output_key_checker)
    {
        ...
        ([&]() {
            return myxmr::htmlresponse(mcnblocks.show_rawoutputkeys());
        });
        ...
        ([&](const crow::request& req) -> myxmr::htmlresponse
         {
            ...
            return myxmr::htmlresponse(
                    mcnblocks.show_checkcheckrawoutput(raw_data, viewkey));
        });
    }
    ...
    ([&]() {
        return myxmr::htmlresponse(mcnblocks.mempool(true));
    });
...
//    });
    ...
    if (enable_js)
    {
        ...
        ([&]() {
            return mcnblocks.get_js_file("jquery.min.js");
        });

        CROW_ROUTE(app, "/js/crc32.js")
        ([&]() {
            return mcnblocks.get_js_file("crc32.js");
        });

        CROW_ROUTE(app, "/js/biginteger.js")
        ([&]() {
            return mcnblocks.get_js_file("biginteger.js");
        });

        CROW_ROUTE(app, "/js/crypto.js")
        ([&]() {
            return mcnblocks.get_js_file("crypto.js");
        });

        CROW_ROUTE(app, "/js/config.js")
        ([&]() {
            return mcnblocks.get_js_file("config.js");
        });

        CROW_ROUTE(app, "/js/nacl-fast-cn.js")
        ([&]() {
            return mcnblocks.get_js_file("nacl-fast-cn.js");
        });

        CROW_ROUTE(app, "/js/base58.js")
        ([&]() {
            return mcnblocks.get_js_file("base58.js");
        });

        CROW_ROUTE(app, "/js/cn_util.js")
        ([&]() {
            return mcnblocks.get_js_file("cn_util.js");
        });

        CROW_ROUTE(app, "/js/sha3.js")
        ([&]() {
            return mcnblocks.get_js_file("sha3.js");
        });
        ...
        ([&]() {
            ...
            return mcnblocks.get_js_file("all_in_one.js");
        });
    ...
    if (enable_json_api)
    {
        ...
        ([&](string tx_hash) {
            ...
            myxmr::jsonresponse r{mcnblocks.json_transaction(remove_bad_chars(tx_hash))};
        ...
        ([&](string tx_hash) {
            ...
            myxmr::jsonresponse r{mcnblocks.json_rawtransaction(remove_bad_chars(tx_hash))};
        ...
        ([&](string tx_hash) {
            ...
            myxmr::jsonresponse r{mcnblocks.json_detailedtransaction(remove_bad_chars(tx_hash))};
        ...
        ([&](string block_no_or_hash) {
            ...
            myxmr::jsonresponse r{mcnblocks.json_block(remove_bad_chars(block_no_or_hash))};
        ...
        ([&](string block_no_or_hash) {
            ...
            myxmr::jsonresponse r{mcnblocks.json_rawblock(remove_bad_chars(block_no_or_hash))};
        ...
        ([&](const crow::request &req) {
            ...
            myxmr::jsonresponse r{mcnblocks.json_transactions(
        ...
        ([&](const crow::request &req) {
            ...
            myxmr::jsonresponse r{mcnblocks.json_mempool(
                    remove_bad_chars(page), remove_bad_chars(limit))};
        ...
        ([&](string search_value) {
            ...
            myxmr::jsonresponse r{mcnblocks.json_search(remove_bad_chars(search_value))};
        ...
        ([&]() {
            ...
            myxmr::jsonresponse r{mcnblocks.json_networkinfo()};
        ...
        ([&]() {
            ...
            myxmr::jsonresponse r{mcnblocks.json_emission()};
        ...
        ([&](const crow::request &req) {
            ...
            myxmr::jsonresponse r{mcnblocks.json_outputs(
                    remove_bad_chars(tx_hash),
        ...
        ([&](const crow::request &req) {
            ...
            myxmr::jsonresponse r{mcnblocks.json_outputsblocks(
        ...
        ([&]() {
            ...
            myxmr::jsonresponse r{mcnblocks.json_version()};
    ...
    if (enable_autorefresh_option)
    {
        ...
        ([&]() {
            uint64_t page_no {0};
            bool refresh_page {true};
            return mcnblocks.index2(page_no, refresh_page);
        });
    }
